...
public class GPSDataConverter {
	...
	public static int toSeconds(String timestr) {
		...
		int secs;
		int hr, min, sec;
		timestr = timestr.substring(TIME_STARTINDEX);
	...
	public static GPSPoint convert(String timeStr, String latitudeStr, String longitudeStr, String elevationStr) {
		...
		double elevationDbl = Double.parseDouble(elevationStr);
		
		gpspoint = new GPSPoint(timeInt, latitudeDbl, longitudeDbl, elevationDbl);
		return gpspoint;
	}
